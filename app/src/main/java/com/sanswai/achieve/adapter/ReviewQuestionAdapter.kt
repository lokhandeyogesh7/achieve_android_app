...
class ReviewQuestionAdapter(private val revQuestionList: ArrayList<ReviewQuestion>?) : RecyclerView.Adapter<ReviewQuestionAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.rbQuestion.rating = position.toFloat()
    }
